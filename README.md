<table width="100%" style="border-collapse: collapse;">
  <tr>
    <td width="180" align="left" style="padding: 20px 10px 20px 0;">
      <img src="logo.png" alt="IslaWine Logo" width="160">
    </td>
    <td style="padding: 20px 0 20px 10px;">
      <h1>🍷 IslaWine</h1>
      <p><strong>用于在Termux中使用Wine + Box64/FEX 运行Windows程序的TUI项目</strong></p>
      <p>
        <a href="LICENSE">
          <img src="https://img.shields.io/badge/License-GPLv3-blue.svg" alt="License: GPL v3">
        </a>
        <a href="https://en.wikipedia.org/wiki/Text-based_user_interface">
          <img src="https://img.shields.io/badge/UI-TUI-blueviolet" alt="TUI">
        </a>
        <a href="https://github.com/termux/termux-app">
          <img src="https://img.shields.io/badge/platform-Termux-blue" alt="Platform">
        </a>
      </p>
    </td>
  </tr>
...
<table align="center">
  <tr>
    <td align="center"><img src="1.jpg" alt="预览图1" width="200"></td>
    <td align="center"><img src="2.jpg" alt="预览图2" width="200"></td>
    <td align="center"><img src="3.jpg" alt="预览图3" width="200"></td>
  </tr>
</table>
